...
| 6. Export + polish | 1–2 | Beancount depth + README demo video script | **Done** | `/review-bugbot` |
| 7. Hardening | 2 | Fuzzing, benchmarks, thesis eval chapter | **In review (this PR)** | `/review-bugbot` + `/review-security` |
